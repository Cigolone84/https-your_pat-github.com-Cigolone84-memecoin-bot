...
SYSTEM_PROMPT = (
    ...
    "7. Consensus8: NUOVA — vota su tutte le altre 5 strategie, prende i top-8 con piu voti\n"
    "   Consensus8 e' la piu affidabile perche non dipende da un solo approccio.\n\n"
    "=== METRICHE RANKING ===\n"
